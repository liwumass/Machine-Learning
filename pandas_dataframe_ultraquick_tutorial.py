...
my_column_names = ('Eleanow', 'Chidi', 'Tahani', 'Jason')
my_dataFrame = pd.DataFrame(np.random.randint(0,100,size=(3, 4)), columns = my_column_names)
print(my_dataFrame)

value = my_dataFrame['Eleanow'].iloc[[1]]  
# value = my_DataFrame[[1]]['Eleanow] 
print(value)
